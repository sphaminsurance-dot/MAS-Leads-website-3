...
export default function Home() {
  useEffect(() => {
    // Dynamically load support.js if needed
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:24px; align-items:stretch;">
              <div style="padding:32px; border-radius:20px; background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.09);">
                <div style="margin-bottom:30px;">
                  <div style="display:flex; justify-content:space-between; align-items:baseline; margin-bottom:12px;"><label style="font-weight:600; font-size:15px; color:#dfe5f0;">Reps / seats</label><span style="color:#2f80ff; font-weight:600;">6</span></div>
                  <input type="range" min="1" max="30" step="1" value="6" style="width:100%; cursor:pointer;">
                </div>
                <div style="margin-bottom:30px;">
                  <div style="display:flex; justify-content:space-between; align-items:baseline; margin-bottom:12px;"><label style="font-weight:600; font-size:15px; color:#dfe5f0;">Calls per day, per rep</label><span style="color:#2f80ff; font-weight:600;">110</span></div>
                  <input type="range" min="40" max="300" step="10" value="110" style="width:100%; cursor:pointer;">
                </div>
                <div style="margin-bottom:30px;">
                  <div style="display:flex; justify-content:space-between; align-items:baseline; margin-bottom:12px;"><label style="font-weight:600; font-size:15px; color:#dfe5f0;">Contact rate</label><span style="color:#2f80ff; font-weight:600;">22%</span></div>
                  <input type="range" min="5" max="60" step="1" value="22" style="width:100%; cursor:pointer;">
                </div>
                <div>
                  <div style="display:flex; justify-content:space-between; align-items:baseline; margin-bottom:12px;"><label style="font-weight:600; font-size:15px; color:#dfe5f0;">Appointment rate</label><span style="color:#2f80ff; font-weight:600;">9%</span></div>
                  <input type="range" min="1" max="40" step="1" value="9" style="width:100%; cursor:pointer;">
                </div>
              </div>
              <div style="display:flex; flex-direction:column; gap:16px;">
                <div style="flex:1; padding:26px 28px; border-radius:20px; background:rgba(47,128,255,0.1); border:1px solid rgba(47,128,255,0.28); display:flex; align-items:center; justify-content:space-between;">
                  ...
                  <div style="font-family:'Space Grotesk'; font-size:40px; font-weight:700; color:#fff;">660</div>
                </div>
                <div style="flex:1; padding:26px 28px; border-radius:20px; background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.09); display:flex; align-items:center; justify-content:space-between;">
                  ...
                  <div style="font-family:'Space Grotesk'; font-size:40px; font-weight:700; color:#fff;">145</div>
                </div>
                <div style="flex:1; padding:26px 28px; border-radius:20px; background:rgba(46,230,160,0.1); border:1px solid rgba(46,230,160,0.28); display:flex; align-items:center; justify-content:space-between;">
                  ...
                  <div style="font-family:'Space Grotesk'; font-size:40px; font-weight:700; color:#2ee6a0;">13</div>
                </div>
              </div>
            </div>
          </section>
