  ...
  <main id="top" style="position:relative; z-index:1;">
    ...
    <section id="how" style="max-width:1100px; margin:0 auto; padding:70px 24px; scroll-margin-top:84px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(4,1fr); gap:16px;">
        <div style="padding:24px; border-radius:15px; background:rgba(255,255,255,0.035); border:1px solid rgba(255,255,255,0.08);">
    ...
    <section id="faq" style="max-width:820px; margin:0 auto; padding:70px 24px; scroll-margin-top:84px;">
      ...
      <div style="display:flex; flex-direction:column; gap:12px;">
        <div style="border-radius:15px; background:rgba(255,255,255,0.035); border:1px solid rgba(255,255,255,0.08); overflow:hidden;">
          <button class="faq-btn" style="width:100%; text-align:left; cursor:pointer; background:transparent; border:none; padding:22px 24px; display:flex; align-items:center; justify-content:space-between; color:#fff; font-family:'Space Grotesk'; font-size:17px; font-weight:600;">
            <span>What type of insurance campaigns do you support?</span><span style="flex-shrink:0; font-size:22px; color:#5e9bff;">+</span>
          </button>
          <div class="faq-answer" style="padding:0 24px 24px; font-size:15px; color:#9aa3b5; line-height:1.65; display:none;">Mas Leads is built around insurance-focused outreach, including final expense, mortgage protection, life insurance, and related insurance products.</div>
        </div>
        <div style="border-radius:15px; background:rgba(255,255,255,0.035); border:1px solid rgba(255,255,255,0.08); overflow:hidden;">
          <button class="faq-btn" style="width:100%; text-align:left; cursor:pointer; background:transparent; border:none; padding:22px 24px; display:flex; align-items:center; justify-content:space-between; color:#fff; font-family:'Space Grotesk'; font-size:17px; font-weight:600;">
            <span>Do you guarantee appointments or sales?</span><span style="flex-shrink:0; font-size:22px; color:#5e9bff;">+</span>
          </button>
          <div class="faq-answer" style="padding:0 24px 24px; font-size:15px; color:#9aa3b5; line-height:1.65; display:none;">No. Results vary based on many factors including lead source, offer, script, market, and follow-up process. Our focus is creating more conversations and opportunities.</div>
        </div>
        <div style="border-radius:15px; background:rgba(255,255,255,0.035); border:1px solid rgba(255,255,255,0.08); overflow:hidden;">
          <button class="faq-btn" style="width:100%; text-align:left; cursor:pointer; background:transparent; border:none; padding:22px 24px; display:flex; align-items:center; justify-content:space-between; color:#fff; font-family:'Space Grotesk'; font-size:17px; font-weight:600;">
            <span>Can agencies purchase call center seats?</span><span style="flex-shrink:0; font-size:22px; color:#5e9bff;">+</span>
          </button>
          <div class="faq-answer" style="padding:0 24px 24px; font-size:15px; color:#9aa3b5; line-height:1.65; display:none;">Yes, depending on current campaign availability and operational capacity. We have flexible seat options to fit different agency sizes.</div>
        </div>
        <div style="border-radius:15px; background:rgba(255,255,255,0.035); border:1px solid rgba(255,255,255,0.08); overflow:hidden;">
          <button class="faq-btn" style="width:100%; text-align:left; cursor:pointer; background:transparent; border:none; padding:22px 24px; display:flex; align-items:center; justify-content:space-between; color:#fff; font-family:'Space Grotesk'; font-size:17px; font-weight:600;">
            <span>Can you work inside our CRM?</span><span style="flex-shrink:0; font-size:22px; color:#5e9bff;">+</span>
          </button>
          <div class="faq-answer" style="padding:0 24px 24px; font-size:15px; color:#9aa3b5; line-height:1.65; display:none;">We can discuss CRM workflow needs and design around your agency's process. We work with tools like Close CRM, GoHighLevel, and Google Sheets.</div>
        </div>
        <div style="border-radius:15px; background:rgba(255,255,255,0.035); border:1px solid rgba(255,255,255,0.08); overflow:hidden;">
          <button class="faq-btn" style="width:100%; text-align:left; cursor:pointer; background:transparent; border:none; padding:22px 24px; display:flex; align-items:center; justify-content:space-between; color:#fff; font-family:'Space Grotesk'; font-size:17px; font-weight:600;">
            <span>Is this for individual agents or agencies?</span><span style="flex-shrink:0; font-size:22px; color:#5e9bff;">+</span>
          </button>
          <div class="faq-answer" style="padding:0 24px 24px; font-size:15px; color:#9aa3b5; line-height:1.65; display:none;">Both, but the strongest fit is agencies and teams that need consistent calling and follow-up support.</div>
        </div>
      </div>
    </section>
        ...
        <div style="padding:32px; border-radius:20px; background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.09);">
          <form id="contact-form" style="display:flex; flex-direction:column; gap:14px;">
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:14px;">
              <div><label style="display:block; font-size:13px; color:#aeb6c6; margin-bottom:7px; font-weight:600;">Name</label><input type="text" placeholder="Your name" style="width:100%; padding:12px; border-radius:10px; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.1); color:#fff; font-family:inherit; box-sizing:border-box;"></div>
              <div><label style="display:block; font-size:13px; color:#aeb6c6; margin-bottom:7px; font-weight:600;">Agency</label><input type="text" placeholder="Agency name" style="width:100%; padding:12px; border-radius:10px; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.1); color:#fff; font-family:inherit; box-sizing:border-box;"></div>
            </div>
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:14px;">
              <div><label style="display:block; font-size:13px; color:#aeb6c6; margin-bottom:7px; font-weight:600;">Email</label><input type="email" placeholder="your@email.com" style="width:100%; padding:12px; border-radius:10px; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.1); color:#fff; font-family:inherit; box-sizing:border-box;"></div>
              <div><label style="display:block; font-size:13px; color:#aeb6c6; margin-bottom:7px; font-weight:600;">Phone</label><input type="tel" placeholder="(123) 456-7890" style="width:100%; padding:12px; border-radius:10px; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.1); color:#fff; font-family:inherit; box-sizing:border-box;"></div>
            </div>
            <div><label style="display:block; font-size:13px; color:#aeb6c6; margin-bottom:7px; font-weight:600;">What do you need help with?</label><textarea placeholder="Tell us..." style="width:100%; padding:12px; border-radius:10px; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.1); color:#fff; font-family:inherit; min-height:80px; resize:vertical; box-sizing:border-box;"></textarea></div>
            <button type="submit" style="width:100%; padding:16px; border-radius:13px; border:none; cursor:pointer; background:linear-gradient(135deg,#2f80ff,#1a5fde); color:#fff; font-weight:700; font-size:16px; font-family:inherit;">Send Request</button>
          </form>
        </div>
      </div>
    </section>
        ...
        <div style="display:flex; gap:60px;">
          <div>
            ...
            <div style="display:flex; flex-direction:column; gap:11px;">
              <a href="#top" style="color:#aeb6c6; text-decoration:none; font-size:15px;">Home</a>
              <a href="#services" style="color:#aeb6c6; text-decoration:none; font-size:15px;">Services</a>
              <a href="#how" style="color:#aeb6c6; text-decoration:none; font-size:15px;">How It Works</a>
              <a href="#faq" style="color:#aeb6c6; text-decoration:none; font-size:15px;">FAQ</a>
              <a href="#contact" style="color:#aeb6c6; text-decoration:none; font-size:15px;">Contact</a>
            </div>
          </div>
          <div>
            ...
            <div style="display:flex; flex-direction:column; gap:11px;">
              <a href="mailto:hello@masleads.com" style="color:#aeb6c6; text-decoration:none; font-size:15px;">hello@masleads.com</a>
              <a href="#contact" style="color:#aeb6c6; text-decoration:none; font-size:15px;">Book a Call</a>
            </div>
          </div>
        </div>
      </div>
      <p style="font-size:12.5px; color:#5a6478; line-height:1.65; border-top:1px solid rgba(255,255,255,0.06); padding-top:24px; margin:0 0 14px;">Mas Leads provides call center and prospecting support for insurance agencies. &copy; 2026 Mas Leads. All rights reserved.</p>
    </div>
  </footer>
...
export default function Home() {
  useEffect(() => {
    ...
    function updateCalculator() {
      ...
      document.getElementById('daily-calls').textContent = dailyCalls.toLocaleString();
      document.getElementById('contacts').textContent = contacts.toLocaleString();
      document.getElementById('appts').textContent = appts.toLocaleString();
    }

    if (repsInput) repsInput.addEventListener('input', updateCalculator);
    if (callsInput) callsInput.addEventListener('input', updateCalculator);
    if (contactInput) contactInput.addEventListener('input', updateCalculator);
    if (apptInput) apptInput.addEventListener('input', updateCalculator);
    ...
    if (form) {
      form.addEventListener('submit', function (e) {
        ...
        btn.style.background = 'linear-gradient(135deg,#2ee6a0,#22c55e)';
        setTimeout(() => {
          btn.textContent = 'Send Request';
          btn.style.background = 'linear-gradient(135deg,#2f80ff,#1a5fde)';
          form.reset();
        }, 3000);
      });
    }
    ...
    // ── Cleanup ──
    return () => {
      if (repsInput) repsInput.removeEventListener('input', updateCalculator);
      if (callsInput) callsInput.removeEventListener('input', updateCalculator);
      if (contactInput) contactInput.removeEventListener('input', updateCalculator);
      if (apptInput) apptInput.removeEventListener('input', updateCalculator);
    };
  }, []);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Mas Leads helps insurance agencies scale outbound calling, lead follow-up, appointment setting, and prospecting." />
        ...
        <style dangerouslySetInnerHTML={{ __html: `
          *, *::before, *::after { box-sizing: border-box; }
          ...
          input[type=text], input[type=email], input[type=tel], textarea { outline:none; }
